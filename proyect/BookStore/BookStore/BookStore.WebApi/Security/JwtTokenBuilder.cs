...
namespace BookStore.WebApi.Security
{
    public sealed class JwtTokenBuilder
    {
        ...
        public const string CONFIGURATION_AUTHENTICATION_SHARED_SECRET_KEY =
            "CONFIGURATION_AUTHENTICATION_SHARED_SECRET_KEY";
        ...
        public static IEnumerable<Claim> GetClaims(string name)
        {
            ...
            return Claims.Union(basicClaims)
        ...
        public static bool ValidateToken(string token, string authorizationKey)
        {
            ...
            try
            {
                var user = handler.ValidateToken(token.Replace($"{BEARER_TOKEN_SCHEME} ", string.Empty), options, out _);
